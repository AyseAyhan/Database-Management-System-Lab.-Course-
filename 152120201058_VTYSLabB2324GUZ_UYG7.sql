...
END;
-- Soru 4 için 
EXEC ListOrderDetailsByDateRange @startDate = '2016-01-01', @endDate = '2016-02-01';
...
BEGIN
    ...
    WHERE active = 0;
END;
EXEC UpdateInactiveStaff @newState = 1;




-- Soru 6: Oluþturulan son saklý yordamý siliniz. (10p)
DROP PROCEDURE IF EXISTS UpdateInactiveStaff;
-- Soru 6 için 
EXEC DropProcedureIfExists 'UpdateInactiveStaff';
